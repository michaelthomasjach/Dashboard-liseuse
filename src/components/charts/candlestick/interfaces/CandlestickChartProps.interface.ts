...
export interface CandlestickChartProps {
  ...
  isLinked?: boolean;
  onLinkClick?: () => void;
  /** Shows a grid/split-screen button in the header (top right) opening a menu of 2/4/6/8-panel
  ...
  splitScreenPanels?: 2 | 4 | 6 | 8;
  onSplitScreenChange?: (panels: 2 | 4 | 6 | 8) => void;
