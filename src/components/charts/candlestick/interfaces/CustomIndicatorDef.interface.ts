...
export interface CustomIndicatorDef {
   ...
   *  down to the pane's own floor, or a bar per reporting date (volume-style) — the three shapes
   *  every fundamentals-style "one number per period" metric realistically needs. */
   ...
   *  `computeCustomIndicatorValues`. */
  data: CustomIndicatorDataPoint[];
  /** Formats the value in badges/legend/pane-axis ticks. Default: 2 decimals. */
